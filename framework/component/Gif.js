(function(){
    var Gif = JM.Gif = function(opts){
        ...
        /*
         * 帧定义，[[ x, : 图片横轴位置 y, : 图片中轴位置 duration : 当前帧持续时间 ]]
         */
        // this.frames = [];
    ...
    Gif.prototype.render = function(context){
        try{
            ...
            context.drawImage(this.img, frame[0], frame[1], this.frameSize[0], this.frameSize[1], this.x, this.y, this.width, this.height);
